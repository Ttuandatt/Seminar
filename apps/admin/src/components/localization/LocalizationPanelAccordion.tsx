...
interface LocalizationAccordionBodyProps {
  language: BCP47Language;
  currentData: PoiLocalization;
  isDirty: boolean;
  isLocked: boolean;
  supportedLanguageInfo: SupportedLanguage | undefined;
  isBaseLanguage: boolean;
...
// NOSONAR
function LocalizationAccordionBody({
  language,
  currentData,
  isDirty,
  isLocked,
  ...
  setIsSaving,
  setIsDeleting,
}: Readonly<LocalizationAccordionBodyProps>) {
  const nameFieldId = `localization-name-${String(language)}`;
  const descriptionFieldId = `localization-description-${String(language)}`;
  ...
  return (
    <div className={styles.accordionItem}>
      ...
      {isExpanded && currentData && (
        <LocalizationAccordionBody
          language={language}
          currentData={currentData}
          isDirty={isDirty}
          isLocked={isLocked}
          supportedLanguageInfo={supportedLanguageInfo}
