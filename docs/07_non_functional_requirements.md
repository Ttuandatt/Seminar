...
| NFR-SEC004 | Rate limiting | 100 req/min per IP | P1 |
| NFR-SEC005 | Input validation | Server-side required | P0 |
| NFR-SEC006 | SQL injection protection | Parameterized queries | P0 |
| NFR-SEC007 | XSS protection | Sanitized output | P0 |
| NFR-SEC008 | CORS configuration | Whitelist origins | P0 |
| NFR-SEC009 | Audit logging | Admin actions | P1 |
...
| NFR-C004 | PWA installable | Yes | P1 |
...
|----------|-------|----------|
| **P0** | 35 | Security, Core performance, Compatibility |
